...
INSERT INTO `MOVIE` (`title`, `director`, `actor`, `opening_date`, `rating`, `runtime`, `image_url`, `genre`, `rated`) VALUES ('토르-러브 앤 썬더', '타이카 와이티티', '크리스 헴스워스, 나탈리 포트만, 테사 톰슨, 크리스찬 베일, 타이카 와이티티', '2022-07-06 00:00:00', '7.8', 119, 'https://caching.lottecinema.co.kr//Media/MovieFile/MovieImg/202207/18748_103_1.jpg', '호러', '15');
